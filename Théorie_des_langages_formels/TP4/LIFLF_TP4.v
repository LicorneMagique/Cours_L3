...
Lemma G1_mime_M1 :
    forall m q, G1 m q
        ->
            exists e, execute M_nb_b_impair q m = Some e
            /\ acceptant M_nb_b_impair e = true.
Proof.
intros m q H_G.
induction H_G.
- exists 2.
...
unfold reconnait.
simpl.
pose (G1_mime_M1 m 1) as G1mimeM1_m_1.
apply G1mimeM1_m_1 in H_G1_ok.
destruct H_G1_ok as [e'].
destruct H as [Hfinal Haccept].
rewrite Hfinal.
simpl in Haccept.
apply Haccept.
Qed.
